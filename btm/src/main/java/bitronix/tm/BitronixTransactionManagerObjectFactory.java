...
public class BitronixTransactionManagerObjectFactory implements ObjectFactory {
    ...
    private static final Logger log = LoggerFactory.getLogger(BitronixTransactionManagerObjectFactory.class);
    ...
    public Object getObjectInstance(Object obj, Name name, Context nameCtx, Hashtable<?, ?> environment) throws Exception {
        if (log.isDebugEnabled()) {
            log.debug("returning the unique transaction manager instance");
        }
